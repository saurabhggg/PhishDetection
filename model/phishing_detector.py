...
# -*- coding: utf-8 -*-
"""
phishing_detector.py – Train multiple models for phishing detection
===================================================================
...
if "label" not in df.columns:
    raise ValueError("❌ Dataset must contain a 'label' column (1=phishing, 0=benign).")
...
# Handle imbalance
# -----------------------------
print("⚖️  Applying SMOTE / oversampling to balance classes...")
try:
    ...
    print(f"✅ After Random Oversampling: {dict(Counter(y_train_bal))}")
...
if best_score < 0.6 or all(v["Recall"] < 0.5 for v in report.values()):
    print("⚠️ Warning: Low recall or overfitting detected. Check dataset balance and feature consistency.")
